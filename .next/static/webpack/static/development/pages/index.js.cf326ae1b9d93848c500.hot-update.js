...
function (_Component) {
  ...
  function AddToDo(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "f2", function () {
      console.log('ok');
    });
  ...
  _createClass(AddToDo, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_Card__WEBPACK_IMPORTED_MODULE_1___default.a, {
        ...
        onClick: this.props.handleAddToDo(this.state.newToDo),
        size: "small",
        variant: "outlined",
        __source: {
          fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.cf326ae1b9d93848c500.hot-update.js.map